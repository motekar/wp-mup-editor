...
mupe.editor = (function( $ ) {
	...
	component = {
		l10n: {
			lintError: {
				singular: 'There is %d error which must be fixed before you can update this file.',
				plural: 'There are %d errors which must be fixed before you can update this file.'
			},
			saveAlert: 'The changes you made will be lost if you navigate away from this page.',
			saveError: 'Something went wrong. Your change may not have been saved. Please try again. There is also a chance that you may need to manually fix and upload the file over FTP.'
		},
		codeEditor: {},
		instance: null,
		noticeElements: {},
	...
	component.submit = function( event ) {
		...
		request = wp.ajax.post( 'mupe-edit-plugin-file', data );
